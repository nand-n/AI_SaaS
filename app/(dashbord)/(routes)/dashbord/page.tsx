...
<div className="">
  <div className="flex justify-between items-center w-full h-full px-2">
    ...
    <div className="grid grid-cols-12 items-center pr-4">
      <div className="col-span-8 col-start-1 flex justify-evenly items-center">
  <div className="mt-2 flex justify-evenly">
    ...
    <div className="mt-2 flex justify-evenly">
      ...
      <div className="col-span-4 col-start-9">
        <div className="w-full h-12 rounded-xl grid grid-cols-4 items-center  bg-gray-100">
          <div className="col-span px-2 py-1">Weekly</div>
          <div className="col-span px-2 py-1">Monthly</div>
          <div className="col-span px-2 py-1">Yearly</div>
          <div className="col-span px-2 py-1">Custom date</div>
